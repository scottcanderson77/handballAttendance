...
// CS 4501 -- Compare to CDpoll-sortxml.php
    ...
    function showCDTable()
    {
	 ...
	 for (var i = 0; i < CDcount; i++)
         ...
         $("#theTable tr").each(function(ind, el)
           {
             if (ind > 0)	// Skip initial row with labels
             {
                 ...
                 $(this).find("input").click(function()
                 {
                     ...
                     $.post('tabulate-xml.php', { "type": 1, "select": theCDs[cdi].id }, 
